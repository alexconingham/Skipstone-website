            ...
            >
              <div className="relative">
                ...
                {showTooltips && hoveredItem === tooltipKey && (
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-4 py-1.5 bg-black/90 backdrop-blur-sm text-white text-xs rounded-lg shadow-xl border border-gray-600 max-w-sm min-w-48 z-50 pointer-events-none">
